          ...
          <form className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select name="region" required>
                <SelectTrigger
                  id="region"
                  className="h-14 text-xl border-2 border-gray-300 focus:border-blue-500"
                >
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select name="desired_job" required>
                <SelectTrigger
                  id="desired_job"
                  className="h-14 text-xl border-2 border-gray-300 focus:border-blue-500"
                >
            ...
            <Button
              type="submit"
              className="h-16 text-2xl font-bold bg-blue-600 hover:bg-blue-700 text-white mt-2 rounded-xl shadow-md"
              disabled
            >
              프로필 등록하기
            </Button>
            <p className="text-center text-gray-400 text-sm">
              * 기능 구현은 다음 단계에서 연결됩니다
            </p>
          </form>
        </CardContent>
      </Card>
